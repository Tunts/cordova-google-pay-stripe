package android.stripe.googlepay;
...
public class StripeGooglePay extends CordovaPlugin {
  ...
  private void requestPayment (String amount, String currency) {
    PaymentDataRequest request = this.createPaymentDataRequest(amount, currency);
